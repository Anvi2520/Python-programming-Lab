#1.Write a python program that has class to store the name,rollno. and marks of students. Display the information (roll number, name and total marks) stored about the student.
class Student:
    marks = []
